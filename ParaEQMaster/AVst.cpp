...
AVst::AVst (audioMasterCallback audioMaster)
	: AudioEffectX (audioMaster, 1, 30)	// 1 program, 2 parameter only
{
    ...
    freqLP2 = (getSampleRate()/2)-10;
    freqHP = 5;
    
    slopeHP = slopeLP = slopeLP2 = 0;
        
    xLP6 = exp(-2.0*cPi_*freqLP/getSampleRate());
    a0LP6 = 1.0-xLP6;
    b1LP6 = -xLP6;

    xLP26 = exp(-2.0*cPi_*freqLP2/getSampleRate());
    a0LP26 = 1.0-xLP26;
    b1LP26 = -xLP26;

    xLP3 = exp(-2.0*cPi_*freqLP2*2/getSampleRate());
    a0LP3 = 1.0-xLP3;
    b1LP3 = -xLP3;
...
void AVst::setParameter (long index, float value)
{
	...
	{     	
        ...
        case 21 : 
        freqLP2Fader = value;
        freqLP2 = min(5+freqLP2Fader*freqLP2Fader*freqLP2Fader*23995,(getSampleRate()/2)-10);
        xLP26 = exp(-2.0*cPi_*freqLP2/getSampleRate());
        a0LP26 = 1.0-xLP26;
        b1LP26 = -xLP26;
        
        
        xLP3 = exp(-2.0*cPi_*    min( freqLP2*4,(getSampleRate()/2)-10 )    /getSampleRate());
        a0LP3 = 1.0-xLP3;
        b1LP3 = -xLP3;
...
float AVst::getParameter (long index)
{
	...
	switch (index)
	{
		...
		case 21 : v = freqLP2Fader;   break;
		case 22 : v = slopeLP2;        break;
		case 23 : v = freqLPFader;   break;
		case 24 : v = slopeLP/2;        break;
		case 25 : v = outVolumeFader;        break;
	}
    return v;
}
...
void AVst::getParameterName (long index, char *label)
{
     	switch (index)
	{
		...
		case 2 : strcpy (label, "Low Shelving (Hard) - - - -");               break;
		case 3 : strcpy (label, "Gain");               break;
		case 3 : strcpy (label, "Low Shelving (Soft) - - - -");               break;
		case 4 : strcpy (label, "Gain");               break;
		case 5 : strcpy (label, "Peaking - - - -");               break;
		case 6 : strcpy (label, "Width");               break;
		case 7 : strcpy (label, "Gain");               break;
		case 8 : strcpy (label, "Peaking - - - -");               break;
		case 9 : strcpy (label, "Width");               break;
		case 10 : strcpy (label, "Gain");               break;
		case 11 : strcpy (label, "Peaking - - - -");               break;
		case 12 : strcpy (label, "Width");               break;
		case 13 : strcpy (label, "Gain");               break;
		case 14 : strcpy (label, "Peaking - - - -");               break;
		case 15 : strcpy (label, "Width");               break;
		case 16 : strcpy (label, "Gain");               break;
		case 17 : strcpy (label, "Peaking - - - -");               break;
		case 18 : strcpy (label, "Width");               break;
		case 19 : strcpy (label, "Gain");               break;
		case 20 : strcpy (label, "Peaking - - - -");               break;
		case 21 : strcpy (label, "Width");               break;
		case 22 : strcpy (label, "Gain");               break;
		case 23 : strcpy (label, "High Shelving - - - -");               break;
		case 24 : strcpy (label, "Gain");               break;
		case 25 : strcpy (label, "Lowpass (Soft) - - - -");              break;
		case 26 : strcpy (label, "Slope");               break;
		case 27 : strcpy (label, "Lowpass (Hard) - - - -");              break;
		case 28 : strcpy (label, "Slope");               break;
		case 29 : strcpy (label, "Output - - - -");               break;
	}
}
...
void AVst::getParameterDisplay (long index, char *text)
{
	switch (index)
	{
        ...
        break;
		case 21 :
            if (freqLP2Fader < 1) float2string (freqLP2, text);
            else if (freqLP2Fader == 1) strcpy (text, "OFF");
        break;
		case 22 :
            if (slopeLP2 == 0) strcpy (text, "~3dB");
            else if (slopeLP2 == 1) strcpy (text, "6dB");
        break;
		case 23 :
...
void AVst::getParameterLabel(long index, char *label)
{
	switch (index)
	{
		...
		case 23 : strcpy (label, "Hz");	break;
		case 24 : strcpy (label, "/Oct");	break;
		case 25 : strcpy (label, "dB");	break;
	}
}
...
{
	strcpy (name, "Parametric EQ MASTER");
	return true;
}
...
{
	strcpy (text, "Parametric EQ MASTER");
	return true;
}
...
void AVst::process (float **inputs, float **outputs, long sampleFrames)
{
    ...
    if (freqHPFader > 0)
    {
        if (slopeHP >= 1)
        {
            ...
            xl2HP = xl1HP; xl1HP = tmp; yl2HP = yl1HP; yl1HP = (*in1);
            
            tmp = (*in2);
            (*in2) = b0HP * (*in2) + b1HP * xr1HP + b2HP * xr2HP - a1HP * yr1HP - a2HP * yr2HP;
            xr2HP = xr1HP; xr1HP = tmp; yr2HP = yr1HP; yr1HP = (*in2);
        }
        if (slopeHP != 1)
        {
...
void AVst::processReplacing (float **inputs, float **outputs, long sampleFrames)
{
    ...
    if (freqLP2Fader < 1)
    {
        if (slopeLP2 == 0) { tmpL = (*in1); tmpR = (*in2); }
        
        (*in1)  = (tmp1LP26 = a0LP26 * (*in1) - b1LP26 * tmp1LP26 ) ;
        (*in2)  = (tmp2LP26 = a0LP26 * (*in2) - b1LP26 * tmp2LP26 ) ; 
        ...
        if (slopeLP2 == 0)
        {
            ...
            (*in1)  = (tmp1LP3 = a0LP3 * (*in1) - b1LP3 * tmp1LP3 ) ;
            (*in2)  = (tmp2LP3 = a0LP3 * (*in2) - b1LP3 * tmp2LP3 ) ;   
        }
