...
// HOPEFULLY CAN DITCH THOSE AT SOME POINT
	...
	float *lookAheadBufferDetL, *lookAheadBufferDetR;
    ...
    float attack, attackSpls, attackFader, attackShape;

    float hold, holdFader;

    float release, releaseSpls, releaseFader, releaseShape;
